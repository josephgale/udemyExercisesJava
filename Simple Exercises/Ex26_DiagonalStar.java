    ...
    public static void printSquareStar(int stars) {
        ...
        if (stars < 5) {
            ...
            while (row <= stars) {
                ...
                //start the column loop which will print "*" or " " based on arguments
                int column = 1;
                while (column <= stars) {
                    if ((row == 1) || (row == stars) || (column == 1) || (column == stars) || (column == row) || (column == (stars - row) + 1)) {
                        System.out.print("*");
                        } else {
                            System.out.print(" ");
                            }
